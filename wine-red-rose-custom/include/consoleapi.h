...
WINBASEAPI BOOL    WINAPI ReadConsoleInputExA(HANDLE,PINPUT_RECORD,DWORD,DWORD *,USHORT);
WINBASEAPI BOOL    WINAPI ReadConsoleInputExW(HANDLE,PINPUT_RECORD,DWORD,DWORD *,USHORT);
