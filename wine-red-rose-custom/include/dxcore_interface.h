...
#define IDXCoreAdapter_GetPropertySize(p,a)          (p)->lpVtbl->GetPropertySize(p,a)
...
#define IDXCoreAdapter_GetPropertySize(p,a)          (p)->GetPropertySize(a)
...
#define IDXCoreAdapterList_Sort(p,a)                         (p)->lpVtbl->Sort(p,a)
...
#define IDXCoreAdapterList_Sort(p,a)                         (p)->Sort(a)
