...
33 cdecl FCICompressorCompress()
35 cdecl FCICompressorClose()
40 cdecl FDIDecompressorCreate()
43 cdecl FDIDecompressorDecompress()
45 cdecl FDIDecompressorClose()