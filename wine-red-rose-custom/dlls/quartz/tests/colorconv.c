...
#define TODO_TIME_END_VALUE (1 << 1)
#define TODO_MEDIA_TIME     (1 << 2)
#define TODO_SYNC_POINT     (1 << 3)
#define TODO_PREROLL        (1 << 4)
        ...
        IMediaControl *control, IMemInputPin *input, struct testfilter *testsink, IBaseFilter *dmo_filter)
{
    ...
    tests[] =
    {
        ...
        },
        {
            ...
            .todo_flags = TODO_TIME_END_VALUE | TODO_MEDIA_TIME
        },
        {
            .flags = SET_TIME,
            .time_start = 20000,
    ...
    for (i = 0; i < ARRAYSIZE(tests); i++)
    {
        ...
        if (tests[i].expected_flags & EXP_TIME)
        {
            ...
            todo_wine_if(tests[i].todo_flags & TODO_TIME_END_VALUE)
