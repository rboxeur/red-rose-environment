    ...
    do {
        ...
        if(first_read) {
            ...
            case BOM_NONE: {
                ...
                INT flags = IS_TEXT_UNICODE_ASCII16 | IS_TEXT_UNICODE_CONTROLS | IS_TEXT_UNICODE_STATISTICS;

                IsTextUnicode(This->nsstream->buf, This->nsstream->buf_size, &flags);
                This->nschannel->charset = strdup(flags ? "utf-16" : "utf-8");
            }
            }
