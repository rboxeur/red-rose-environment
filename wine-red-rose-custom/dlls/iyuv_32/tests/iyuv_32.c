...
static void convert_yuv_and_write_bitmap(const BITMAPINFOHEADER *bitmap_header, const BYTE *data, yuv_to_bgr32_converter convert, const WCHAR *output_filename)
{
...
static void test_compress(DWORD handler)
{
    ...
    ok(i420_info.biCompression == FOURCC_IYUV,
    ...
    res = ICCompress(hic, ICCOMPRESS_KEYFRAME, &i420_info, i420_data,
            (BITMAPINFOHEADER *)rgb_info, (void *)rgb_data, NULL, &flags, 1, 0, 0, NULL, NULL);
    ok(res == ICERR_OK, "Got %ld.\n", res);
