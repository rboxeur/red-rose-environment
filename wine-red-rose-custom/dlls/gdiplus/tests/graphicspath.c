...
static void test_is_outline_visible_path_point(void)
{
    ...
    status = GdipCreatePen1((ARGB)0xffff00ff, 4.0f, UnitMillimeter, &penmm);
    expect(Ok, status);
    ok(penmm != NULL, "Expected pen to be initialized\n");
    ...
    /* Page Unit in Millimeters, Pen Unit in pixels */
    GdipResetWorldTransform(graphics);
    status = GdipSetPageUnit(graphics, UnitMillimeter);
    expect(Ok, status);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 0.0, 2.0, pen, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 1.0, 2.0, pen, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = FALSE;
    status = GdipIsOutlineVisiblePathPoint(path, 2.0, 2.0, pen, graphics, &result);
    expect(Ok, status);
    expect(TRUE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 3.0, 2.0, pen, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 14.0, 2.0, pen, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = FALSE;
    status = GdipIsOutlineVisiblePathPoint(path, 15.0, 2.0, pen, graphics, &result);
    expect(Ok, status);
    expect(TRUE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 16.0, 2.0, pen, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);

    /* Pen Unit in Millimeters */
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 0.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 0.5, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 1.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = FALSE;
    status = GdipIsOutlineVisiblePathPoint(path, 2.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(TRUE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 3.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 4.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 5.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 6.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 7.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 8.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 9.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 10.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 11.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 12.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 13.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 14.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = FALSE;
    status = GdipIsOutlineVisiblePathPoint(path, 15.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(TRUE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 16.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 20.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 24.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 30.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 34.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 40.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 44.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 45.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 46.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
    result = TRUE;
    status = GdipIsOutlineVisiblePathPoint(path, 47.0, 2.0, penmm, graphics, &result);
    expect(Ok, status);
    expect(FALSE, result);
