        ...
        ID2D1SimplifiedGeometrySink *sink)
{
    ...
    coeff = 4.0f * (M_SQRT2 - 1.0f) / 3.0f;

    start_point.x = -1.0f;
    start_point.y = 0.0f;

    segments[0].point1.x =  -1.0f;
    segments[0].point1.y = -coeff;
    segments[0].point2.x = -coeff;
    segments[0].point2.y =  -1.0f;
    segments[0].point3.x =   0.0f;
    segments[0].point3.y =  -1.0f;

    segments[1].point1.x =  coeff;
    segments[1].point1.y =  -1.0f;
    segments[1].point2.x =   1.0f;
    segments[1].point2.y = -coeff;
    segments[1].point3.x =   1.0f;
    segments[1].point3.y =   0.0f;

    segments[2].point1.x =  1.0f;
    segments[2].point1.y = coeff;
    segments[2].point2.x = coeff;
    segments[2].point2.y =  1.0f;
    segments[2].point3.x =  0.0f;
    segments[2].point3.y =  1.0f;

    segments[3].point1.x = -coeff;
    segments[3].point1.y =   1.0f;
    segments[3].point2.x =  -1.0f;
    segments[3].point2.y =  coeff;
    segments[3].point3 = start_point;
