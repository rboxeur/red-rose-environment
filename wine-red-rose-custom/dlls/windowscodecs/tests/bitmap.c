...
{
    static BYTE data[] = { 1,2,3, 4,5,6 };
    static BYTE data_rotate90[] = { 4,1, 5,2, 6,3 };
    HRESULT hr;
    IWICBitmap *bitmap;
    IWICPalette *palette;
    ...
    hr = IWICBitmapFlipRotator_Initialize(fr, (IWICBitmapSource *)bitmap, WICBitmapTransformRotate90);
    ok(hr == S_OK, "got %#lx\n", hr);
